...
from dbsync.api.controllers.v1.identity import assignment
from dbsync.api.controllers.v1.identity import identity
from dbsync.api.controllers.v1.identity import project
from dbsync.api.controllers.v1.identity import role
from dbsync.api.controllers.v1.identity import token_revoke_event
...
class IdentityController(object):
    ...
    def _get_resource_controller(self, remainder):
        ...
        res_controllers["assignments"] = assignment.AssignmentsController
