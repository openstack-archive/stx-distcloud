...
class RevokeEventsController(object):
    ...
    def post(self):
        ...
        try:
            ...
            response.status = 201
            return db_api.revoke_event_db_model_to_dict(revoke_event_ref)
...
class UsersController(object):
    ...
    def get(self, event_id=None):
        ...
        try:
            ...
            revoke_event = db_api.revoke_event_get(context, user_id=user_id,
            ...
            pecan.abort(404, _("Token revocation event with user_id %s"
                               " and issued_before doesn't exist.") %
    ...
    def delete(self, event_id=None):
        ...
        try:
            ...
            user_id = event_tags[0]
            issued_before = event_tags[1]
            db_api.revoke_event_delete(context, user_id=user_id,
                                       issued_before=issued_before)
            ...
            pecan.abort(404, _("Token revocation event with user id %s"
                               " doesn't exist.") % user_id)
...
class AuditsController(object):
    ...
    def get(self, audit_id=None):
        ...
        try:
            revoke_event = db_api.revoke_event_get(context, audit_id=audit_id)
            return revoke_event
    ...
    def delete(self, audit_id=None):
        ...
        try:
            db_api.revoke_event_delete(context, audit_id=audit_id)
            response.headers['Content-Type'] = None
