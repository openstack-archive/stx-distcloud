...
from dbsync.api import api_config
from dbsync.api import app

from dbsync.common import config
from dbsync.common import messaging

CONF = cfg.CONF
config.register_options()
LOG = logging.getLogger('dbsync.api')
...
def main():
    ...
    messaging.setup()
    systemd.notify_once()
    service = wsgi.Server(CONF, "DBsync", application, host, port)
