...
class BadRequest(DBsyncException):
...
class Conflict(DBsyncException):
...
class ServiceUnavailable(DBsyncException):
...
class InUse(DBsyncException):
    message = _("The resource is inuse")


class InvalidConfigurationOption(DBsyncException):
