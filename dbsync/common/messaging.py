...
from dbsync.common import context

TRANSPORT = None
NOTIFIER = None

_ALIASES = {
    'dbsync.openstack.common.rpc.impl_kombu': 'rabbit',
    'dbsync.openstack.common.rpc.impl_qpid': 'qpid',
    'dbsync.openstack.common.rpc.impl_zmq': 'zmq',
}
...
def setup(url=None, optional=False):
    ...
    if not TRANSPORT:
        oslo_messaging.set_transport_defaults('dbsync')
        exmods = ['dbsync.common.exception']
        try:
