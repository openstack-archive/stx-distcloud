...
from dbsync.dbsyncclient import httpclient
from dbsync.dbsyncclient.v1.identity import assignment_manager as am
from dbsync.dbsyncclient.v1.identity import identity_manager as im
from dbsync.dbsyncclient.v1.identity import project_manager as pm
from dbsync.dbsyncclient.v1.identity import role_manager as rm
from dbsync.dbsyncclient.v1.identity import token_revoke_event_manager as trem
...
class Client(object):
    ...
    def __init__(self, dbsync_agent_url=None, username=None, api_key=None,
        ...
        self.assignment_manager = am.assignment_manager(self.http_client)
