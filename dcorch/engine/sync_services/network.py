...
class NetworkSyncThread(SyncThread):
    ...
    def same_security_group(self, qc1, qc2):
        ...
        # between regions.
        # TODO: This solution only works if we have a one domain within
        # keystone, otherwise we should we need to get the the tenant name from
        # the master resource database.
